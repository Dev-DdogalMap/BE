...
public interface BookmarkRepository extends JpaRepository<Bookmark, Long> {
    ...
    @Query(value = """
        ...
        ORDER BY
            CASE WHEN :sort = 'FOOD_SCORE' THEN rs.food_score END DESC NULLS LAST,
            CASE WHEN :sort = 'RATING' THEN rs.average_score END DESC NULLS LAST,
            CASE WHEN :sort = 'REVIEW_COUNT' THEN COALESCE(rs.review_count, 0) END DESC,
            CASE WHEN :sort = 'LATEST' THEN b.created_at END DESC,
            b.created_at DESC
        """, nativeQuery = true)
